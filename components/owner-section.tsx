...
export default function OwnerSection({ gymName, city, phone }: SectionProps) {
    return (
        <section className="py-16 md:py-24 px-7">
            <div className=" grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                <div>
                    <div className="text-primary text-sm bg-primary/20 rounded-full border border-primary text-center max-w-35">Why {gymName}</div>
                ...
                <div className="relative overflow-hidden  border border-foreground/10 bg-black">
                    <img
                        ...
                        src="/gym/pexels-foadshariyati-30283460.jpg"
                    />
