    ...
    return <div className="flex min-h-screen items-center justify-center pt-30 pb-16 overflow-hidden">
        <div className=" w-full max-w-(--breakpoint-xl) px-6 xl:px-0">
            <div className="text-center">
                <b className="font-medium text-white text-center text-sm uppercase tracking-wide">
                    Contact Us | <span className="text-primary">{gymName} Gym</span>
                </b>
                <h2 className="mt-3 text-center text-white/80 font-medium text-4xl tracking-[-0.04em]">
                    We&apos;d love to hear from you
                </h2>
                <p className=" text-center mt-3 text-white/80 text-lg  md:text-xl">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span>
                                        <span className="block font-heading text-xl font-black uppercase text-white">
                                            Address
                                        </span>
